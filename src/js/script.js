class BooksList {
    ...
    templates = {
        menuBook: Handlebars.compile(document.querySelector(this.select.templateOf.menuBook).innerHTML),
    };
    favoriteBooks = [];
    filters = [];
    ...
    getElements() {
        const thisBooksList = this;
        thisBooksList.dom = {};
        thisBooksList.dom.booksListContainer = document.querySelector(thisBooksList.select.booksList);
        thisBooksList.dom.filters = document.querySelector(thisBooksList.select.filters);
    }
    ...
    render() {
        ...
        for (let book of thisBooksList.data) {
            ...
            // console.log(book);
            const generatedHTML = this.templates.menuBook(book);
    ...
    initActions() {
        ...
        thisBooksList.dom.booksListContainer.addEventListener('dblclick', function (event) {
            ...
            const bookLinkClicked = parent.classList.contains(thisBooksList.select.bookImage);
            if (bookLinkClicked) {
    ...
    filterBooks() {
        const thisBooksList = this;
        const booksListContainerEl = document.querySelector(thisBooksList.select.booksList);
        for (let book of thisBooksList.data) {
